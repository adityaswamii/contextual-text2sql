...
class MSchema:
    ...
    def single_table_mschema(self, table_name: str, selected_columns: List | None = None,
    ...
    def to_mschema(self, selected_tables: List | None = None, selected_columns: List | None = None,
                   example_num=3, show_type_detail=False) -> str:
        """
